...
with duckdb.connect(database=pravah_db_location) as conn:  # Use context manager for connection
    create_tables(conn)
...
def chat_page():
    ...
    if prompt := st.chat_input("What is your question?"):
        ...
        with duckdb.connect(database=pravah_db_location) as conn:  
